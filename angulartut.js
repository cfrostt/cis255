...
app1.controller('ctrl1', function($scope) {
 ...
 app1.controller('random',function($scope) {
	var courses =  [{num: 'CIS 190', name: 'Special Topics'},{num: 'CIS 255', name: 'Client Side Web Application Development'},{num: 'CIS 311', name: 'Windows Programming With Vb.Net'},{num: 'CIS 333', name: 'Introduction to System Software'},{num: 'CIS 355', name: 'Server Side Web Application Development'},{num: 'CIS 357', name: 'Advanced Programming with Java'},{num: 'CIS 366', name: 'Information Technology Project Mgt'},{num: 'CIS 371', name: 'Storage Devices & File Manipulation Tech'},{num: 'CIS 386', name: 'Database Management Systems'},{num: 'CIS 390', name: 'Special Topics'}];
 
	acourse = courses[Math.floor((Math.random() * courses.length))];
	$scope.course = 'Course Number: ' + acourse.num + ', Course: ' + acourse.name
 });
  app1.controller('list',function($scope) {
	var courses =  [{num: 'CIS 190', name: 'Special Topics'},{num: 'CIS 255', name: 'Client Side Web Application Development'},{num: 'CIS 311', name: 'Windows Programming With Vb.Net'},{num: 'CIS 333', name: 'Introduction to System Software'},{num: 'CIS 355', name: 'Server Side Web Application Development'},{num: 'CIS 357', name: 'Advanced Programming with Java'},{num: 'CIS 366', name: 'Information Technology Project Mgt'},{num: 'CIS 371', name: 'Storage Devices & File Manipulation Tech'},{num: 'CIS 386', name: 'Database Management Systems'},{num: 'CIS 390', name: 'Special Topics'}];
  });
